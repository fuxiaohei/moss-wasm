use anyhow::Result;
use md5::{Digest, Md5};
use moss_lib::metadata::{Metadata, MetadataEnv, DEFAULT_METADATA_FILE};
...
pub async fn deploy(env: &MetadataEnv, meta: &Metadata, bundle: &Bundle) -> Result<()> {
    // create client
    ...
    let req = BundleUploadRequest {
        ...
        function_type: meta.language.clone(),
